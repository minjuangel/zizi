...
# --- License Info ---
LICENSE_URL="https://raw.githubusercontent.com/minjuangel/mz/main/izin"
...
echo "✅ Instalasi selesai. Service ZiVPN harusnya aktif dan panel bisa mendeteksi."
    ...
    wget -O /usr/local/bin/zivpn_helper.sh https://raw.githubusercontent.com/minjuangel/zizi/main/zivpn_helper.sh
    if [ $? -ne 0 ]; then
